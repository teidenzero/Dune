# Paul Atreides animation set

11 RGBA PNG strips, 65 frames, 400 x 336 pixels per frame. Generated with the built-in image generator using the authorized new `paul_reference.png` design in the Scout's painted style.
