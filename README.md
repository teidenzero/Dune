...
**1.2 The Banquet** follows 1.1 (launcher key `9`): the Lady Jessica's dinner for five notables of Arrakeen. Each has a hidden agenda; Jessica can read two of them (READ), and Paul's prescience can glimpse how a guest will take a reply. Choose replies course by course (`1` `2` `3`), keep the table's composure from running out, and at the end decide whether to name the Harkonnen informant. What the player learns decides the evening; the results say plainly what it cost and bought.
